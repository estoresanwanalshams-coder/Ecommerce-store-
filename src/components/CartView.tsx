      ...
      <section className="page-shell">
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="content-reveal rounded-2xl border border-zinc-200 bg-white p-10 text-center shadow-sm">
            ...
            <Link
              href="/categories"
              className="animated-button mt-8 inline-flex rounded-md bg-zinc-950 px-6 py-3 text-sm font-bold text-white transition hover:bg-zinc-700"
            >
              Browse Products
            </Link>
          </div>
    ...
    <section className="page-shell">
      <div className="mx-auto grid max-w-7xl gap-8 px-4 py-12 sm:px-6 lg:grid-cols-[1fr_360px] lg:px-8">
        ...
        <aside className="content-reveal h-fit rounded-2xl bg-zinc-950 p-6 text-white shadow-xl">
          ...
          <Link
            href="/categories"
            className="mt-3 flex justify-center rounded-md border border-white/20 px-6 py-3 text-sm font-bold text-white transition hover:bg-white/10"
          >
            Continue Shopping
          </Link>
        </aside>
